...
#~     restriction_dic <- hashmap(c('UKR','RUS','ARG','BOL','ETH','IND','KAZ','NPL','PAK','SRB','GIN','SYR'),c(1.0,0.5,1.,0.875,1.,1.,0.25,0.33,1.,1.,1.,0.916))
#~     print(restriction_dic)
...
#~     quit()
    ...
    i_restrict = which(country_list[,2] =='BLR')
    reduce_factor <-  0.75
    #   Add *restricted* exports to reserves
    Rcurrent[i_restrict] = Rcurrent[i_restrict] + reduce_factor*sum(E0[i_restrict,])
    #  Impose export restrictions by reducing exports
...
#~     quit()
    ...
    i_restrict = which(country_list[,2] =='GUI')
    reduce_factor <-  1.
    #   Add *restricted* exports to reserves
    Rcurrent[i_restrict] = Rcurrent[i_restrict] + reduce_factor*sum(E0[i_restrict,])
    #  Impose export restrictions by reducing exports
